 ...
 * 坐标转换
 */
public class PanoCoordinateActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pano_coordinate);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (null == input_lat.getText() || "".equals(input_lat.getText().toString())) {
                    Toast.makeText(PanoCoordinateActivity.this, "请输入纬度", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (null == input_lont.getText() || "".equals(input_lont.getText().toString())) {
                    Toast.makeText(PanoCoordinateActivity.this, "请输入经度", Toast.LENGTH_SHORT).show();
                    return;
                }
